...
<h3 class="page-header"><center>Manage Course</center></h3>
<div class="col-lg-8" style="margin:15px;">

<form method="post" action="<?= base_url() ?>Crud/manage_course">
...
<div class="control-group form-group">
    	<div class="controls">
        	<label>Select Programme Name</label>
<select name="myPgm" id="myPgm" class="form-control" required>
<option selected disabled>Select</option>
</select> 
<br>
