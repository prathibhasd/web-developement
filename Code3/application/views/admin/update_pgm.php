...
<h3 class="page-header"><center>Update Programme Details</center></h3>
...
echo "<tr>
<td height='50' width='160'>Programme No:  </th><th><input type='text' id='id' value='$row->Pgm_no' class='form-control' readonly /></th>
</tr>";	

echo "<tr>
<td height='50' width='160'>Programme Code:  </th><th><input type='text' id='pcode' value='$row->Pgm_code' class='form-control' /></th>
</tr>";	

echo "<tr>
<td height='50' width='30'>Programme Name:  </th><th><input type='text' id='pname' value='$row->Pgm_name' class='form-control'/></th>
</tr>";

echo "<tr>
<td height='50' width='30'>Department Name:  </th><th><input type='text' id='dname' value='$row->Dept_name' class='form-control' readonly/></th>
</tr>";

echo "<tr>
<td height='50' width='160'>Campus Code:  </th><th><input type='text' id='ccode' value='$row->Campus_code' class='form-control' readonly/></th>
</tr>";	
