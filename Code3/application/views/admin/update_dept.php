...
<h3 class="page-header"><center>Update Department Details</center></h3>
...
echo "<tr>
<td height='50' width='160'>Department Code:  </th><th><input type='text' id='did' value='$row->Dept_code' class='form-control' readonly /></th>
</tr>";	

echo "<tr>
<td height='50' width='30'>Department Name:  </th><th><input type='text' id='dname' value='$row->Dept_name' class='form-control'/></th>
</tr>";

echo "<tr>
<td height='50' width='30'>Campus Code:  </th><th><input type='text' id='ccode' value='$row->Campus_code' class='form-control'readonly /></th>
</tr>";
