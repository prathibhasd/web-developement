...
<head>
	...
	<!--<link href="http://localhost/Code3/js/sweetalert.min.js" type="text/javascript">-->
...
<h3 class="page-header"><center>Update Campus Details</center></h3>
...
echo "<tr>
<td height='50' width='160'>Campus Code:  </th><th><input type='text' id='cid' value='$row->Campus_code' class='form-control' readonly /></th>
</tr>";	

echo "<tr>
<td height='50' width='30'>Campus Name:  </th><th><input type='text' id='cname' value='$row->Campus_name' class='form-control'/></th>
</tr>";
