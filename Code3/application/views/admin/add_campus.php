...
<h3 class="page-header"><center>Add Campus</center></h3>
<div class="col-lg-8" style="margin:15px;">
	...
	<?php if (isset($message)) :?>
		...
		<script>
        	swal({
						title: "Inserted!",
						text: "Campus Details Inserted Successfully!",
						icon: "success"
				}).then(function() {
						window.location = "manage_campus";
				});
				</script>
        </div>
		<?php endif; ?>
    	...
    	<div class="controls">
        	...
        	swal({
						title: "Error!",
						text: "Campus Details Alredy Exists!",
						icon: "error"
				}).then(function() {
						window.location = "manage_campus";
				});
...
<form method="post" action='<?= base_url() ?>Crud/insert_campus'>
	<div class="form-group">
    	
			<div class="control-group form-group">
				<div class="controls">
				<label>Enter Campus Name</label>
					<input type="text" name="cname" id="cname" pattern="^[a-zA-Z,  -]*$" title="Valid characters: Alphabets, Comma and -" class="form-control" required>
       </div>
   	</div>
   	</div>
	   ...
	   <div class="control-group form-group">
    	<div class="controls">
            	<input type="submit" class="btn btn-success" name="save" value="Add New Campus">
</div>
	</form>
