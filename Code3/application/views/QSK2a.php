...
<h2 style="color:Black;"><center>ಪ್ರಶ್ನಾವಳಿ ಸಂಖ್ಯೆ -೨</center></h2>
...
<?php 	 
  ...
  <?php
         ...
         foreach ($user as $row)  
         {  ?>
			<h3 style="color:Black;">ಚತುರ್ಮಾಸ/ ಅವಧಿ/ವರ್ಷ:<input type="text" name="Sem" value="<?php echo $row->Sem?>"></h3>
...
?>
 ...
 <tr>
  ...
  <td style="text-align:left">ಅಧ್ಯಾಪಕರು ವಿದ್ಯಾರ್ಥಿಗಳಲ್ಲಿ ಆಸಕ್ತಿಯನ್ನು ಮೂಡಿಸುವ ಶಕ್ತಿ</td>
  <?php
  $P4=$j;
  $m4=1;
  while($P4-1>0) {
