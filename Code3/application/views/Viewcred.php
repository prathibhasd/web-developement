...
<h3 class="page-header"><center>View Credential Details</center></h3>
<div class="col-lg-8" style="margin:15px;">

	<form method="post" action="<?= base_url() ?>Crud/Pdfview">
...
<div class="control-group form-group">
    	<div class="controls">
		 ...
		 <div class="control-group form-group">
    	<div class="controls">
            	<input type="submit" class="btn btn-success" name="save" value="View">
        </div>
  	</div>
